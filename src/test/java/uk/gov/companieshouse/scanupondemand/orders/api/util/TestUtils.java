...
public class TestUtils {
	...
	/**
	 * Configures the CH Java SDKs used in WireMock based integration tests to
	 * interact with with WireMock stubbed/mocked API endpoints.
	 * 
	 * @param environment the Spring {@link Environment} the tests are run in
	 * @param variables   {@link EnvironmentVariables} class rule permitting
