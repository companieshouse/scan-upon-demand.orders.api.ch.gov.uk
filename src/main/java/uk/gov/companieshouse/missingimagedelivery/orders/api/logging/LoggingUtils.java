package uk.gov.companieshouse.missingimagedelivery.orders.api.logging;
...
public class LoggingUtils {
    ...
    public static final String APPLICATION_NAMESPACE = "missing-image-delivery.orders.api.ch.gov.uk";
