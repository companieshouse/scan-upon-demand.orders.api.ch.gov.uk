...
exec java -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=21095 -jar -Dserver.port="${PORT}" "${APP_DIR}/missing-image-delivery.orders.api.ch.gov.uk.jar"
